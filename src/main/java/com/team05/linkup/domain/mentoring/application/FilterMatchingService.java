...
public class FilterMatchingService {
    ...
    public MentorProfileDTO getMentor(User mentor) {
        ...
        return MentorProfileDTO.builder()
                ...
                .interest(mentor.getInterest().getDisplayName())
                .profileImageUrl(mentor.getProfileImageUrl())
                .area(areaName)
                .sigungu(sigunguName)
                .activityTime(mentor.getActivityTime().getDisplayName())
        ...
        return users.stream()
                .map(user -> {
                    ...
                    return MentorCardDTO.builder()
                            ...
                            .activityTime(user.getActivityTime().getDisplayName())
                            .activityType(user.getActivityType().getDisplayName())
                            .build();
                })
                .collect(Collectors.toList());
    }
